...
def postprocessing(src: str, dst: str, set: str, threshold: float, connec: int = 6, min_vol: int = -1):
    ...
    Example:
        ...
        ├── RibFrac400-pred_mask.nii.gz
        ├── RibFrac401-pred_mask.nii.gz
        ├── ...
        └── RibFrac500-pred_mask.nii.gz
    ...
    for filepath in filelist:
        ...
        pred_mask = np.load(filepath)  # (z, y, x) array
        pred_mask = pred_mask.T  # (x, y, z) array
        ...
        nib.save(labels_out, os.path.join(dst, f"RibFrac{public_id}-pred_mask.nii.gz"))
